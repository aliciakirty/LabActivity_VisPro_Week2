...
//   Or just paste it over lib/lab02_start.dart and run normally.
//
...
import 'features/menu/presentation/widgets/menu_search.dart';
import 'features/menu/domain/menu_item.dart';
import 'features/menu/presentation/widgets/list_menu.dart';
import 'features/menu/presentation/widgets/order_summary_bar.dart';
        ...
        children: [
          ...
          Expanded(
            child: visible.isEmpty
              ...
              onQuantityChanged: (String id, int quantity) {
                setState(() {
